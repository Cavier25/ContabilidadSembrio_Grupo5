<?php
    class Usuarios extends Controllers{
        ...
        public function Usuarios()
        {
            ...
            $data['tag_tag'] = "Usuarios";
            $data['page_title'] = "USUARIOS <small>Contabilidad</small>";
			...
			if($_SESSION['permisosMod']['r']){
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($_SESSION['permisosMod']['u']){
						if(($_SESSION['idUser'] == 8 and $_SESSION['userData']['idrol'] == 27) ||
							($_SESSION['userData']['idrol'] == 27 and $arrData[$i]['idrol'] != 27) ){
					...
					if($_SESSION['permisosMod']['d']){
						if(($_SESSION['idUser'] == 8 and $_SESSION['userData']['idrol'] == 27) ||
							($_SESSION['userData']['idrol'] == 27 and $arrData[$i]['idrol'] != 27) and
